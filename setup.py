...
if __name__ == '__main__':
    cuda_ext = os.getenv('LBASICSR_EXT')  # whether compile cuda ext
    if cuda_ext == 'True':
        try:
            import torch
    ...
    setup(
        name='lbasicsr',
        version=get_version(),
        description='Open Source Image and Video Arbitrary-Scale Super-Resolution Toolbox',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='Zekun Li',
        author_email='lizekun98@stu.xidian.edu.cn',
        keywords='computer vision, arbitrary-scale, super resolution',
        url='https://github.com/Weepingchestnut/LbasicSR',
