...
from lbasicsr.utils import scandir
...
def generate_meta_info_div2k():
    ...
    gt_folder = '/data2/lzk_data/workspace/LbasicSR/datasets/DIV2K/DIV2K_train_HR_sub/'
    meta_info_txt = '/data2/lzk_data/workspace/LbasicSR/lbasicsr/data/meta_info/meta_info_DIV2K800sub_GT.txt'
