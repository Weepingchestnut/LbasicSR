...
from lbasicsr.data.degradations import random_add_gaussian_noise_pt, random_add_poisson_noise_pt, \
    only_generate_gaussian_noise_pt, only_generate_poisson_noise_pt
from lbasicsr.data.transforms import paired_random_crop_return_indexes
from lbasicsr.models.srgan_dynamic_model import SRGANDynamicModel
from lbasicsr.utils import DiffJPEG, USMSharp
from lbasicsr.utils.img_process_util import filter2D
        ...
        if self.is_train:
            ...
            if self.degradation_degree == 'severe_degrade_two_stage':
                ...
                jpeg_p = out.new_zeros(out.size(0)).uniform_(
                    *self.opt['jpeg_range'])  # tensor([61.6463, 94.2723, 37.1205, 34.9564], device='cuda:0')]
