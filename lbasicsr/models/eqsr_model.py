        ...
        if hasattr(self, 'net_g_ema'):
            ...
            with torch.no_grad():
                if self.flag:
                    ...
                    self.output = self.net_g_ema(self.img, self.coord, self.cell, self.mod_pad_h, self.mod_pad_w, self.scale)
        else:
            self.net_g.eval()
            with torch.no_grad():
                if self.flag:
                    ...
                    self.output = self.net_g(self.img, self.coord, self.cell, self.mod_pad_h, self.mod_pad_w, self.scale)
