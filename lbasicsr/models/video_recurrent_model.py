...
@MODEL_REGISTRY.register()
class ASVideoRecurrentModel_SAM(VideoRecurrentModel):

    def __init__(self, opt):
        super(ASVideoRecurrentModel_SAM, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        self.cri_pix(self.net_g(self.lq), self.gt).backward()
