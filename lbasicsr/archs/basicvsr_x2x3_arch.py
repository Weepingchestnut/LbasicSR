...
class BasicVSR_x2(nn.Module):
    """A recurrent network for video SR. Now only x2 is supported.
    ...
    def __init__(self, num_feat=64, num_block=15, spynet_path=None, scale=2):
        super().__init__()
...
@ARCH_REGISTRY.register()
class BasicVSR_x3(nn.Module):
    """A recurrent network for video SR. Now only x3 is supported.
    ...
    def __init__(self, num_feat=64, num_block=15, spynet_path=None, scale=3):
        super().__init__()
        self.num_feat = num_feat
