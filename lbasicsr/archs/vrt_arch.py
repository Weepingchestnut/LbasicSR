...
class SpyNet(nn.Module):
    ...
    def process(self, ref, supp, w, h, w_floor, h_floor):
        ...
        ref = [self.preprocess(ref)]        # [torch.Size([13, 3, 32, 32])]
        supp = [self.preprocess(supp)]      # [torch.Size([13, 3, 32, 32])]
...
class VRT(nn.Module):
    ...
    def forward(self, x):
        # x: (N, D, C, H, W)    train: torch.Size([1, 7, 3, 64, 64])
...
if __name__ == '__main__':
    ...
    # 003_VRT_videosr_bi_Vimeo_7frames, 004_VRT_videosr_bd_Vimeo_7frames -----------------------
    model = VRT(upscale=4,
                img_size=[8, 64, 64],
                window_size=[8, 8, 8],
                depths=[8, 8, 8, 8, 8, 8, 8, 4, 4, 4, 4, 4, 4],
                ...
                spynet_path=None,
                pa_frames=4,
                deformable_groups=16).to(device)
...
|:--------------------------------------|:-----------------------|:-----------|:---------------|
| model                                 | 30.676M                | 2.164T     | 13.94G         |
|  conv_first                           |  29.28K                |  2.867G    |  11.796M       |
|   conv_first.weight                   |   (120, 27, 1, 3, 3)   |            |                |
|   conv_first.bias                     |   (120,)               |            |                |
|  spynet                               |  1.44M                 |  57.646G   |  35.075M       |
|   spynet.basic_module                 |   1.44M                |   57.635G  |   35.075M      |
|    spynet.basic_module.0.basic_module |    0.24M               |    42.223M |    25.696K     |
|    spynet.basic_module.1.basic_module |    0.24M               |    0.169G  |    0.103M      |
|    spynet.basic_module.2.basic_module |    0.24M               |    0.676G  |    0.411M      |
|    spynet.basic_module.3.basic_module |    0.24M               |    2.702G  |    1.645M      |
|    spynet.basic_module.4.basic_module |    0.24M               |    10.809G |    6.578M      |
|    spynet.basic_module.5.basic_module |    0.24M               |    43.236G |    26.313M     |
|  stage1                               |  2.9M                  |  0.353T    |  2.018G        |
|   stage1.reshape.1                    |   0.24K                |   58.982M  |   0            |
|    stage1.reshape.1.weight            |    (120,)              |            |                |
|    stage1.reshape.1.bias              |    (120,)              |            |                |
|   stage1.residual_group1.blocks       |   1.245M               |   0.147T   |   1.67G        |
|    stage1.residual_group1.blocks.0    |    0.208M              |    24.466G |    0.278G      |
|    stage1.residual_group1.blocks.1    |    0.208M              |    24.466G |    0.278G      |
|    stage1.residual_group1.blocks.2    |    0.208M              |    24.466G |    0.278G      |
|    stage1.residual_group1.blocks.3    |    0.208M              |    24.466G |    0.278G      |
|    stage1.residual_group1.blocks.4    |    0.208M              |    24.466G |    0.278G      |
|    stage1.residual_group1.blocks.5    |    0.208M              |    24.466G |    0.278G      |
|   stage1.linear1                      |   14.52K               |   1.416G   |   11.796M      |
|    stage1.linear1.weight              |    (120, 120)          |            |                |
|    stage1.linear1.bias                |    (120,)              |            |                |
|   stage1.residual_group2.blocks       |   0.321M               |   17.105G  |   0.118G       |
|    stage1.residual_group2.blocks.0    |    0.16M               |    8.552G  |    58.982M     |
|    stage1.residual_group2.blocks.1    |    0.16M               |    8.552G  |    58.982M     |
|   stage1.linear2                      |   14.52K               |   1.416G   |   11.796M      |
|    stage1.linear2.weight              |    (120, 120)          |            |                |
|    stage1.linear2.bias                |    (120,)              |            |                |
|   stage1.pa_deform                    |   1.001M               |   0.157T   |   0.123G       |
|    stage1.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage1.pa_deform.bias              |    (120,)              |            |                |
|    stage1.pa_deform.conv_offset       |    0.871M              |    0.157T  |    0.123G      |
|   stage1.pa_fuse                      |   0.303M               |   29.727G  |   82.575M      |
|    stage1.pa_fuse.fc11                |    0.13M               |    12.74G  |    35.389M     |
|    stage1.pa_fuse.fc12                |    0.13M               |    12.74G  |    35.389M     |
|    stage1.pa_fuse.fc2                 |    43.32K              |    4.247G  |    11.796M     |
|  stage2                               |  2.958M                |  89.831G   |  0.507G        |
|   stage2.reshape                      |   58.68K               |   1.475G   |   2.949M       |
|    stage2.reshape.1                   |    0.96K               |    58.982M |    0           |
|    stage2.reshape.2                   |    57.72K              |    1.416G  |    2.949M      |
|   stage2.residual_group1.blocks       |   1.245M               |   36.699G  |   0.418G       |
|    stage2.residual_group1.blocks.0    |    0.208M              |    6.116G  |    69.599M     |
|    stage2.residual_group1.blocks.1    |    0.208M              |    6.116G  |    69.599M     |
|    stage2.residual_group1.blocks.2    |    0.208M              |    6.116G  |    69.599M     |
|    stage2.residual_group1.blocks.3    |    0.208M              |    6.116G  |    69.599M     |
|    stage2.residual_group1.blocks.4    |    0.208M              |    6.116G  |    69.599M     |
|    stage2.residual_group1.blocks.5    |    0.208M              |    6.116G  |    69.599M     |
|   stage2.linear1                      |   14.52K               |   0.354G   |   2.949M       |
|    stage2.linear1.weight              |    (120, 120)          |            |                |
|    stage2.linear1.bias                |    (120,)              |            |                |
|   stage2.residual_group2.blocks       |   0.321M               |   4.276G   |   29.491M      |
|    stage2.residual_group2.blocks.0    |    0.16M               |    2.138G  |    14.746M     |
|    stage2.residual_group2.blocks.1    |    0.16M               |    2.138G  |    14.746M     |
|   stage2.linear2                      |   14.52K               |   0.354G   |   2.949M       |
|    stage2.linear2.weight              |    (120, 120)          |            |                |
|    stage2.linear2.bias                |    (120,)              |            |                |
|   stage2.pa_deform                    |   1.001M               |   39.22G   |   30.818M      |
|    stage2.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage2.pa_deform.bias              |    (120,)              |            |                |
|    stage2.pa_deform.conv_offset       |    0.871M              |    39.22G  |    30.818M     |
|   stage2.pa_fuse                      |   0.303M               |   7.432G   |   20.644M      |
|    stage2.pa_fuse.fc11                |    0.13M               |    3.185G  |    8.847M      |
|    stage2.pa_fuse.fc12                |    0.13M               |    3.185G  |    8.847M      |
|    stage2.pa_fuse.fc2                 |    43.32K              |    1.062G  |    2.949M      |
|  stage3                               |  2.958M                |  22.458G   |  0.127G        |
|   stage3.reshape                      |   58.68K               |   0.369G   |   0.737M       |
|    stage3.reshape.1                   |    0.96K               |    14.746M |    0           |
|    stage3.reshape.2                   |    57.72K              |    0.354G  |    0.737M      |
|   stage3.residual_group1.blocks       |   1.245M               |   9.175G   |   0.104G       |
|    stage3.residual_group1.blocks.0    |    0.208M              |    1.529G  |    17.4M       |
|    stage3.residual_group1.blocks.1    |    0.208M              |    1.529G  |    17.4M       |
|    stage3.residual_group1.blocks.2    |    0.208M              |    1.529G  |    17.4M       |
|    stage3.residual_group1.blocks.3    |    0.208M              |    1.529G  |    17.4M       |
|    stage3.residual_group1.blocks.4    |    0.208M              |    1.529G  |    17.4M       |
|    stage3.residual_group1.blocks.5    |    0.208M              |    1.529G  |    17.4M       |
|   stage3.linear1                      |   14.52K               |   88.474M  |   0.737M       |
|    stage3.linear1.weight              |    (120, 120)          |            |                |
|    stage3.linear1.bias                |    (120,)              |            |                |
|   stage3.residual_group2.blocks       |   0.321M               |   1.069G   |   7.373M       |
|    stage3.residual_group2.blocks.0    |    0.16M               |    0.535G  |    3.686M      |
|    stage3.residual_group2.blocks.1    |    0.16M               |    0.535G  |    3.686M      |
|   stage3.linear2                      |   14.52K               |   88.474M  |   0.737M       |
|    stage3.linear2.weight              |    (120, 120)          |            |                |
|    stage3.linear2.bias                |    (120,)              |            |                |
|   stage3.pa_deform                    |   1.001M               |   9.805G   |   7.705M       |
|    stage3.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage3.pa_deform.bias              |    (120,)              |            |                |
|    stage3.pa_deform.conv_offset       |    0.871M              |    9.805G  |    7.705M      |
|   stage3.pa_fuse                      |   0.303M               |   1.858G   |   5.161M       |
|    stage3.pa_fuse.fc11                |    0.13M               |    0.796G  |    2.212M      |
|    stage3.pa_fuse.fc12                |    0.13M               |    0.796G  |    2.212M      |
|    stage3.pa_fuse.fc2                 |    43.32K              |    0.265G  |    0.737M      |
|  stage4                               |  2.958M                |  5.614G    |  31.712M       |
|   stage4.reshape                      |   58.68K               |   92.16M   |   0.184M       |
|    stage4.reshape.1                   |    0.96K               |    3.686M  |    0           |
|    stage4.reshape.2                   |    57.72K              |    88.474M |    0.184M      |
|   stage4.residual_group1.blocks       |   1.245M               |   2.294G   |   26.1M        |
|    stage4.residual_group1.blocks.0    |    0.208M              |    0.382G  |    4.35M       |
|    stage4.residual_group1.blocks.1    |    0.208M              |    0.382G  |    4.35M       |
|    stage4.residual_group1.blocks.2    |    0.208M              |    0.382G  |    4.35M       |
|    stage4.residual_group1.blocks.3    |    0.208M              |    0.382G  |    4.35M       |
|    stage4.residual_group1.blocks.4    |    0.208M              |    0.382G  |    4.35M       |
|    stage4.residual_group1.blocks.5    |    0.208M              |    0.382G  |    4.35M       |
|   stage4.linear1                      |   14.52K               |   22.118M  |   0.184M       |
|    stage4.linear1.weight              |    (120, 120)          |            |                |
|    stage4.linear1.bias                |    (120,)              |            |                |
|   stage4.residual_group2.blocks       |   0.321M               |   0.267G   |   1.843M       |
|    stage4.residual_group2.blocks.0    |    0.16M               |    0.134G  |    0.922M      |
|    stage4.residual_group2.blocks.1    |    0.16M               |    0.134G  |    0.922M      |
|   stage4.linear2                      |   14.52K               |   22.118M  |   0.184M       |
|    stage4.linear2.weight              |    (120, 120)          |            |                |
|    stage4.linear2.bias                |    (120,)              |            |                |
|   stage4.pa_deform                    |   1.001M               |   2.451G   |   1.926M       |
|    stage4.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage4.pa_deform.bias              |    (120,)              |            |                |
|    stage4.pa_deform.conv_offset       |    0.871M              |    2.451G  |    1.926M      |
|   stage4.pa_fuse                      |   0.303M               |   0.464G   |   1.29M        |
|    stage4.pa_fuse.fc11                |    0.13M               |    0.199G  |    0.553M      |
|    stage4.pa_fuse.fc12                |    0.13M               |    0.199G  |    0.553M      |
|    stage4.pa_fuse.fc2                 |    43.32K              |    66.355M |    0.184M      |
|  stage5                               |  2.903M                |  22.112G   |  0.127G        |
|   stage5.reshape                      |   3.78K                |   23.04M   |   0.737M       |
|    stage5.reshape.1                   |    60                  |    0.922M  |    0           |
|    stage5.reshape.2                   |    3.72K               |    22.118M |    0.737M      |
|   stage5.residual_group1.blocks       |   1.245M               |   9.175G   |   0.104G       |
|    stage5.residual_group1.blocks.0    |    0.208M              |    1.529G  |    17.4M       |
|    stage5.residual_group1.blocks.1    |    0.208M              |    1.529G  |    17.4M       |
|    stage5.residual_group1.blocks.2    |    0.208M              |    1.529G  |    17.4M       |
|    stage5.residual_group1.blocks.3    |    0.208M              |    1.529G  |    17.4M       |
|    stage5.residual_group1.blocks.4    |    0.208M              |    1.529G  |    17.4M       |
|    stage5.residual_group1.blocks.5    |    0.208M              |    1.529G  |    17.4M       |
|   stage5.linear1                      |   14.52K               |   88.474M  |   0.737M       |
|    stage5.linear1.weight              |    (120, 120)          |            |                |
|    stage5.linear1.bias                |    (120,)              |            |                |
|   stage5.residual_group2.blocks       |   0.321M               |   1.069G   |   7.373M       |
|    stage5.residual_group2.blocks.0    |    0.16M               |    0.535G  |    3.686M      |
|    stage5.residual_group2.blocks.1    |    0.16M               |    0.535G  |    3.686M      |
|   stage5.linear2                      |   14.52K               |   88.474M  |   0.737M       |
|    stage5.linear2.weight              |    (120, 120)          |            |                |
|    stage5.linear2.bias                |    (120,)              |            |                |
|   stage5.pa_deform                    |   1.001M               |   9.805G   |   7.705M       |
|    stage5.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage5.pa_deform.bias              |    (120,)              |            |                |
|    stage5.pa_deform.conv_offset       |    0.871M              |    9.805G  |    7.705M      |
|   stage5.pa_fuse                      |   0.303M               |   1.858G   |   5.161M       |
|    stage5.pa_fuse.fc11                |    0.13M               |    0.796G  |    2.212M      |
|    stage5.pa_fuse.fc12                |    0.13M               |    0.796G  |    2.212M      |
|    stage5.pa_fuse.fc2                 |    43.32K              |    0.265G  |    0.737M      |
|  stage6                               |  2.903M                |  88.449G   |  0.507G        |
|   stage6.reshape                      |   3.78K                |   92.16M   |   2.949M       |
|    stage6.reshape.1                   |    60                  |    3.686M  |    0           |
|    stage6.reshape.2                   |    3.72K               |    88.474M |    2.949M      |
|   stage6.residual_group1.blocks       |   1.245M               |   36.699G  |   0.418G       |
|    stage6.residual_group1.blocks.0    |    0.208M              |    6.116G  |    69.599M     |
|    stage6.residual_group1.blocks.1    |    0.208M              |    6.116G  |    69.599M     |
|    stage6.residual_group1.blocks.2    |    0.208M              |    6.116G  |    69.599M     |
|    stage6.residual_group1.blocks.3    |    0.208M              |    6.116G  |    69.599M     |
|    stage6.residual_group1.blocks.4    |    0.208M              |    6.116G  |    69.599M     |
|    stage6.residual_group1.blocks.5    |    0.208M              |    6.116G  |    69.599M     |
|   stage6.linear1                      |   14.52K               |   0.354G   |   2.949M       |
|    stage6.linear1.weight              |    (120, 120)          |            |                |
|    stage6.linear1.bias                |    (120,)              |            |                |
|   stage6.residual_group2.blocks       |   0.321M               |   4.276G   |   29.491M      |
|    stage6.residual_group2.blocks.0    |    0.16M               |    2.138G  |    14.746M     |
|    stage6.residual_group2.blocks.1    |    0.16M               |    2.138G  |    14.746M     |
|   stage6.linear2                      |   14.52K               |   0.354G   |   2.949M       |
|    stage6.linear2.weight              |    (120, 120)          |            |                |
|    stage6.linear2.bias                |    (120,)              |            |                |
|   stage6.pa_deform                    |   1.001M               |   39.22G   |   30.818M      |
|    stage6.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage6.pa_deform.bias              |    (120,)              |            |                |
|    stage6.pa_deform.conv_offset       |    0.871M              |    39.22G  |    30.818M     |
|   stage6.pa_fuse                      |   0.303M               |   7.432G   |   20.644M      |
|    stage6.pa_fuse.fc11                |    0.13M               |    3.185G  |    8.847M      |
|    stage6.pa_fuse.fc12                |    0.13M               |    3.185G  |    8.847M      |
|    stage6.pa_fuse.fc2                 |    43.32K              |    1.062G  |    2.949M      |
|  stage7                               |  2.903M                |  0.354T    |  2.03G         |
|   stage7.reshape                      |   3.78K                |   0.369G   |   11.796M      |
|    stage7.reshape.1                   |    60                  |    14.746M |    0           |
|    stage7.reshape.2                   |    3.72K               |    0.354G  |    11.796M     |
|   stage7.residual_group1.blocks       |   1.245M               |   0.147T   |   1.67G        |
|    stage7.residual_group1.blocks.0    |    0.208M              |    24.466G |    0.278G      |
|    stage7.residual_group1.blocks.1    |    0.208M              |    24.466G |    0.278G      |
|    stage7.residual_group1.blocks.2    |    0.208M              |    24.466G |    0.278G      |
|    stage7.residual_group1.blocks.3    |    0.208M              |    24.466G |    0.278G      |
|    stage7.residual_group1.blocks.4    |    0.208M              |    24.466G |    0.278G      |
|    stage7.residual_group1.blocks.5    |    0.208M              |    24.466G |    0.278G      |
|   stage7.linear1                      |   14.52K               |   1.416G   |   11.796M      |
|    stage7.linear1.weight              |    (120, 120)          |            |                |
|    stage7.linear1.bias                |    (120,)              |            |                |
|   stage7.residual_group2.blocks       |   0.321M               |   17.105G  |   0.118G       |
|    stage7.residual_group2.blocks.0    |    0.16M               |    8.552G  |    58.982M     |
|    stage7.residual_group2.blocks.1    |    0.16M               |    8.552G  |    58.982M     |
|   stage7.linear2                      |   14.52K               |   1.416G   |   11.796M      |
|    stage7.linear2.weight              |    (120, 120)          |            |                |
|    stage7.linear2.bias                |    (120,)              |            |                |
|   stage7.pa_deform                    |   1.001M               |   0.157T   |   0.123G       |
|    stage7.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage7.pa_deform.bias              |    (120,)              |            |                |
|    stage7.pa_deform.conv_offset       |    0.871M              |    0.157T  |    0.123G      |
|   stage7.pa_fuse                      |   0.303M               |   29.727G  |   82.575M      |
|    stage7.pa_fuse.fc11                |    0.13M               |    12.74G  |    35.389M     |
|    stage7.pa_fuse.fc12                |    0.13M               |    12.74G  |    35.389M     |
|    stage7.pa_fuse.fc2                 |    43.32K              |    4.247G  |    11.796M     |
|  stage8                               |  8.298M                |  1.026T    |  8.296G        |
|   stage8.0                            |   22.02K               |   2.182G   |   17.695M      |
|    stage8.0.1                         |    0.24K               |    58.982M |    0           |
|    stage8.0.2                         |    21.78K              |    2.123G  |    17.695M     |
|   stage8.1                            |   1.397M               |   0.186T   |   1.631G       |
|    stage8.1.residual_group.blocks     |    1.365M              |    0.182T  |    1.614G      |
|    stage8.1.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.2                            |   1.397M               |   0.186T   |   1.631G       |
|    stage8.2.residual_group.blocks     |    1.365M              |    0.182T  |    1.614G      |
|    stage8.2.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.3                            |   1.397M               |   0.186T   |   1.631G       |
|    stage8.3.residual_group.blocks     |    1.365M              |    0.182T  |    1.614G      |
|    stage8.3.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.4                            |   1.397M               |   0.186T   |   1.631G       |
|    stage8.4.residual_group.blocks     |    1.365M              |    0.182T  |    1.614G      |
|    stage8.4.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.5                            |   1.343M               |   0.14T    |   0.876G       |
|    stage8.5.residual_group.blocks     |    1.311M              |    0.137T  |    0.859G      |
|    stage8.5.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.6                            |   1.343M               |   0.14T    |   0.876G       |
|    stage8.6.residual_group.blocks     |    1.311M              |    0.137T  |    0.859G      |
|    stage8.6.linear                    |    32.58K              |    3.185G  |    17.695M     |
|  norm                                 |  0.36K                 |  88.474M   |  0             |
|   norm.weight                         |   (180,)               |            |                |
|   norm.bias                           |   (180,)               |            |                |
|  conv_after_body                      |  21.72K                |  2.123G    |  11.796M       |
|   conv_after_body.weight              |   (120, 180)           |            |                |
|   conv_after_body.bias                |   (120,)               |            |                |
|  conv_before_upsample.0               |  69.184K               |  6.795G    |  6.291M        |
|   conv_before_upsample.0.weight       |   (64, 120, 1, 3, 3)   |            |                |
|   conv_before_upsample.0.bias         |   (64,)                |            |                |
|  upsample                             |  0.332M                |  0.13T     |  0.226G        |
|   upsample.0                          |   0.148M               |   14.496G  |   25.166M      |
|    upsample.0.weight                  |    (256, 64, 1, 3, 3)  |            |                |
|    upsample.0.bias                    |    (256,)              |            |                |
|   upsample.5                          |   0.148M               |   57.982G  |   0.101G       |
|    upsample.5.weight                  |    (256, 64, 1, 3, 3)  |            |                |
|    upsample.5.bias                    |    (256,)              |            |                |
|   upsample.10                         |   36.928K              |   57.982G  |   0.101G       |
|    upsample.10.weight                 |    (64, 64, 1, 3, 3)   |            |                |
|    upsample.10.bias                   |    (64,)               |            |                |
|  conv_last                            |  1.731K                |  2.718G    |  4.719M        |
|   conv_last.weight                    |   (3, 64, 1, 3, 3)     |            |                |
|   conv_last.bias                      |   (3,)                 |            |                |
torch.Size([2, 12, 3, 256, 256])

# 002_VRT_videosr_bi_REDS_16frames -------------------------------------------------------------
| module                                | #parameters or shape   | #flops     | #activations   |
|:--------------------------------------|:-----------------------|:-----------|:---------------|
| model                                 | 35.135M                | 2.693T     | 17.385G        |
|  conv_first                           |  29.28K                |  2.867G    |  11.796M       |
|   conv_first.weight                   |   (120, 27, 1, 3, 3)   |            |                |
|   conv_first.bias                     |   (120,)               |            |                |
|  spynet                               |  1.44M                 |  57.646G   |  35.075M       |
...
|    stage1.linear1.weight              |    (120, 120)          |            |                |
|    stage1.linear1.bias                |    (120,)              |            |                |
|   stage1.residual_group2.blocks       |   0.332M               |   17.105G  |   0.118G       |
|    stage1.residual_group2.blocks.0    |    0.166M              |    8.552G  |    58.982M     |
|    stage1.residual_group2.blocks.1    |    0.166M              |    8.552G  |    58.982M     |
|   stage1.linear2                      |   14.52K               |   1.416G   |   11.796M      |
|    stage1.linear2.weight              |    (120, 120)          |            |                |
|    stage1.linear2.bias                |    (120,)              |            |                |
|   stage1.pa_deform                    |   1.615M               |   0.267T   |   0.182G       |
|    stage1.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage1.pa_deform.bias              |    (120,)              |            |                |
|    stage1.pa_deform.conv_offset       |    1.485M              |    0.267T  |    0.182G      |
|   stage1.pa_fuse                      |   0.303M               |   29.727G  |   82.575M      |
|    stage1.pa_fuse.fc11                |    0.13M               |    12.74G  |    35.389M     |
|    stage1.pa_fuse.fc12                |    0.13M               |    12.74G  |    35.389M     |
|    stage1.pa_fuse.fc2                 |    43.32K              |    4.247G  |    11.796M     |
|  stage2                               |  3.583M                |  0.118T    |  0.522G        |
|   stage2.reshape                      |   58.68K               |   1.475G   |   2.949M       |
|    stage2.reshape.1                   |    0.96K               |    58.982M |    0           |
|    stage2.reshape.2                   |    57.72K              |    1.416G  |    2.949M      |
|   stage2.residual_group1.blocks       |   1.245M               |   36.699G  |   0.418G       |
...
|    stage2.linear1.weight              |    (120, 120)          |            |                |
|    stage2.linear1.bias                |    (120,)              |            |                |
|   stage2.residual_group2.blocks       |   0.332M               |   4.276G   |   29.491M      |
|    stage2.residual_group2.blocks.0    |    0.166M              |    2.138G  |    14.746M     |
|    stage2.residual_group2.blocks.1    |    0.166M              |    2.138G  |    14.746M     |
|   stage2.linear2                      |   14.52K               |   0.354G   |   2.949M       |
|    stage2.linear2.weight              |    (120, 120)          |            |                |
|    stage2.linear2.bias                |    (120,)              |            |                |
|   stage2.pa_deform                    |   1.615M               |   66.859G  |   45.416M      |
|    stage2.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage2.pa_deform.bias              |    (120,)              |            |                |
|    stage2.pa_deform.conv_offset       |    1.485M              |    66.859G |    45.416M     |
|   stage2.pa_fuse                      |   0.303M               |   7.432G   |   20.644M      |
|    stage2.pa_fuse.fc11                |    0.13M               |    3.185G  |    8.847M      |
|    stage2.pa_fuse.fc12                |    0.13M               |    3.185G  |    8.847M      |
|    stage2.pa_fuse.fc2                 |    43.32K              |    1.062G  |    2.949M      |
|  stage3                               |  3.583M                |  29.378G   |  0.13G         |
|   stage3.reshape                      |   58.68K               |   0.369G   |   0.737M       |
|    stage3.reshape.1                   |    0.96K               |    14.746M |    0           |
|    stage3.reshape.2                   |    57.72K              |    0.354G  |    0.737M      |
|   stage3.residual_group1.blocks       |   1.245M               |   9.175G   |   0.104G       |
...
|    stage3.linear1.weight              |    (120, 120)          |            |                |
|    stage3.linear1.bias                |    (120,)              |            |                |
|   stage3.residual_group2.blocks       |   0.332M               |   1.069G   |   7.373M       |
|    stage3.residual_group2.blocks.0    |    0.166M              |    0.535G  |    3.686M      |
|    stage3.residual_group2.blocks.1    |    0.166M              |    0.535G  |    3.686M      |
|   stage3.linear2                      |   14.52K               |   88.474M  |   0.737M       |
|    stage3.linear2.weight              |    (120, 120)          |            |                |
|    stage3.linear2.bias                |    (120,)              |            |                |
|   stage3.pa_deform                    |   1.615M               |   16.715G  |   11.354M      |
|    stage3.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage3.pa_deform.bias              |    (120,)              |            |                |
|    stage3.pa_deform.conv_offset       |    1.485M              |    16.715G |    11.354M     |
|   stage3.pa_fuse                      |   0.303M               |   1.858G   |   5.161M       |
|    stage3.pa_fuse.fc11                |    0.13M               |    0.796G  |    2.212M      |
|    stage3.pa_fuse.fc12                |    0.13M               |    0.796G  |    2.212M      |
|    stage3.pa_fuse.fc2                 |    43.32K              |    0.265G  |    0.737M      |
|  stage4                               |  3.583M                |  7.345G    |  32.625M       |
|   stage4.reshape                      |   58.68K               |   92.16M   |   0.184M       |
|    stage4.reshape.1                   |    0.96K               |    3.686M  |    0           |
|    stage4.reshape.2                   |    57.72K              |    88.474M |    0.184M      |
|   stage4.residual_group1.blocks       |   1.245M               |   2.294G   |   26.1M        |
...
|    stage4.linear1.weight              |    (120, 120)          |            |                |
|    stage4.linear1.bias                |    (120,)              |            |                |
|   stage4.residual_group2.blocks       |   0.332M               |   0.267G   |   1.843M       |
|    stage4.residual_group2.blocks.0    |    0.166M              |    0.134G  |    0.922M      |
|    stage4.residual_group2.blocks.1    |    0.166M              |    0.134G  |    0.922M      |
|   stage4.linear2                      |   14.52K               |   22.118M  |   0.184M       |
|    stage4.linear2.weight              |    (120, 120)          |            |                |
|    stage4.linear2.bias                |    (120,)              |            |                |
|   stage4.pa_deform                    |   1.615M               |   4.179G   |   2.839M       |
|    stage4.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage4.pa_deform.bias              |    (120,)              |            |                |
|    stage4.pa_deform.conv_offset       |    1.485M              |    4.179G  |    2.839M      |
|   stage4.pa_fuse                      |   0.303M               |   0.464G   |   1.29M        |
|    stage4.pa_fuse.fc11                |    0.13M               |    0.199G  |    0.553M      |
|    stage4.pa_fuse.fc12                |    0.13M               |    0.199G  |    0.553M      |
|    stage4.pa_fuse.fc2                 |    43.32K              |    66.355M |    0.184M      |
|  stage5                               |  3.528M                |  29.033G   |  0.13G         |
|   stage5.reshape                      |   3.78K                |   23.04M   |   0.737M       |
|    stage5.reshape.1                   |    60                  |    0.922M  |    0           |
|    stage5.reshape.2                   |    3.72K               |    22.118M |    0.737M      |
|   stage5.residual_group1.blocks       |   1.245M               |   9.175G   |   0.104G       |
...
|    stage5.linear1.weight              |    (120, 120)          |            |                |
|    stage5.linear1.bias                |    (120,)              |            |                |
|   stage5.residual_group2.blocks       |   0.332M               |   1.069G   |   7.373M       |
|    stage5.residual_group2.blocks.0    |    0.166M              |    0.535G  |    3.686M      |
|    stage5.residual_group2.blocks.1    |    0.166M              |    0.535G  |    3.686M      |
|   stage5.linear2                      |   14.52K               |   88.474M  |   0.737M       |
|    stage5.linear2.weight              |    (120, 120)          |            |                |
|    stage5.linear2.bias                |    (120,)              |            |                |
|   stage5.pa_deform                    |   1.615M               |   16.715G  |   11.354M      |
|    stage5.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage5.pa_deform.bias              |    (120,)              |            |                |
|    stage5.pa_deform.conv_offset       |    1.485M              |    16.715G |    11.354M     |
|   stage5.pa_fuse                      |   0.303M               |   1.858G   |   5.161M       |
|    stage5.pa_fuse.fc11                |    0.13M               |    0.796G  |    2.212M      |
|    stage5.pa_fuse.fc12                |    0.13M               |    0.796G  |    2.212M      |
|    stage5.pa_fuse.fc2                 |    43.32K              |    0.265G  |    0.737M      |
|  stage6                               |  3.528M                |  0.116T    |  0.522G        |
|   stage6.reshape                      |   3.78K                |   92.16M   |   2.949M       |
|    stage6.reshape.1                   |    60                  |    3.686M  |    0           |
|    stage6.reshape.2                   |    3.72K               |    88.474M |    2.949M      |
|   stage6.residual_group1.blocks       |   1.245M               |   36.699G  |   0.418G       |
...
|    stage6.linear1.weight              |    (120, 120)          |            |                |
|    stage6.linear1.bias                |    (120,)              |            |                |
|   stage6.residual_group2.blocks       |   0.332M               |   4.276G   |   29.491M      |
|    stage6.residual_group2.blocks.0    |    0.166M              |    2.138G  |    14.746M     |
|    stage6.residual_group2.blocks.1    |    0.166M              |    2.138G  |    14.746M     |
|   stage6.linear2                      |   14.52K               |   0.354G   |   2.949M       |
|    stage6.linear2.weight              |    (120, 120)          |            |                |
|    stage6.linear2.bias                |    (120,)              |            |                |
|   stage6.pa_deform                    |   1.615M               |   66.859G  |   45.416M      |
|    stage6.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage6.pa_deform.bias              |    (120,)              |            |                |
|    stage6.pa_deform.conv_offset       |    1.485M              |    66.859G |    45.416M     |
|   stage6.pa_fuse                      |   0.303M               |   7.432G   |   20.644M      |
|    stage6.pa_fuse.fc11                |    0.13M               |    3.185G  |    8.847M      |
|    stage6.pa_fuse.fc12                |    0.13M               |    3.185G  |    8.847M      |
|    stage6.pa_fuse.fc2                 |    43.32K              |    1.062G  |    2.949M      |
|  stage7                               |  3.528M                |  0.465T    |  2.088G        |
|   stage7.reshape                      |   3.78K                |   0.369G   |   11.796M      |
|    stage7.reshape.1                   |    60                  |    14.746M |    0           |
|    stage7.reshape.2                   |    3.72K               |    0.354G  |    11.796M     |
|   stage7.residual_group1.blocks       |   1.245M               |   0.147T   |   1.67G        |
...
|    stage7.linear1.weight              |    (120, 120)          |            |                |
|    stage7.linear1.bias                |    (120,)              |            |                |
|   stage7.residual_group2.blocks       |   0.332M               |   17.105G  |   0.118G       |
|    stage7.residual_group2.blocks.0    |    0.166M              |    8.552G  |    58.982M     |
|    stage7.residual_group2.blocks.1    |    0.166M              |    8.552G  |    58.982M     |
|   stage7.linear2                      |   14.52K               |   1.416G   |   11.796M      |
|    stage7.linear2.weight              |    (120, 120)          |            |                |
|    stage7.linear2.bias                |    (120,)              |            |                |
|   stage7.pa_deform                    |   1.615M               |   0.267T   |   0.182G       |
|    stage7.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage7.pa_deform.bias              |    (120,)              |            |                |
|    stage7.pa_deform.conv_offset       |    1.485M              |    0.267T  |    0.182G      |
|   stage7.pa_fuse                      |   0.303M               |   29.727G  |   82.575M      |
|    stage7.pa_fuse.fc11                |    0.13M               |    12.74G  |    35.389M     |
|    stage7.pa_fuse.fc12                |    0.13M               |    12.74G  |    35.389M     |
|    stage7.pa_fuse.fc2                 |    43.32K              |    4.247G  |    11.796M     |
|  stage8                               |  8.384M                |  1.263T    |  11.587G       |
|   stage8.0                            |   22.02K               |   2.182G   |   17.695M      |
|    stage8.0.1                         |    0.24K               |    58.982M |    0           |
|    stage8.0.2                         |    21.78K              |    2.123G  |    17.695M     |
|   stage8.1                            |   1.419M               |   0.245T   |   2.454G       |
|    stage8.1.residual_group.blocks     |    1.386M              |    0.242T  |    2.436G      |
|    stage8.1.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.2                            |   1.419M               |   0.245T   |   2.454G       |
|    stage8.2.residual_group.blocks     |    1.386M              |    0.242T  |    2.436G      |
|    stage8.2.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.3                            |   1.419M               |   0.245T   |   2.454G       |
|    stage8.3.residual_group.blocks     |    1.386M              |    0.242T  |    2.436G      |
|    stage8.3.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.4                            |   1.419M               |   0.245T   |   2.454G       |
|    stage8.4.residual_group.blocks     |    1.386M              |    0.242T  |    2.436G      |
|    stage8.4.linear                    |    32.58K              |    3.185G  |    17.695M     |
|   stage8.5                            |   1.343M               |   0.14T    |   0.876G       |
|    stage8.5.residual_group.blocks     |    1.311M              |    0.137T  |    0.859G      |
|    stage8.5.linear                    |    32.58K              |    3.185G  |    17.695M     |
...
|    stage1.linear2.weight              |    (120, 120)          |            |                |
|    stage1.linear2.bias                |    (120,)              |            |                |
|   stage1.pa_deform                    |   1.249M               |   0.202T   |   0.143G       |
|    stage1.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage1.pa_deform.bias              |    (120,)              |            |                |
|    stage1.pa_deform.conv_offset       |    1.12M               |    0.202T  |    0.143G      |
|   stage1.pa_fuse                      |   0.303M               |   29.727G  |   82.575M      |
|    stage1.pa_fuse.fc11                |    0.13M               |    12.74G  |    35.389M     |
|    stage1.pa_fuse.fc12                |    0.13M               |    12.74G  |    35.389M     |
|    stage1.pa_fuse.fc2                 |    43.32K              |    4.247G  |    11.796M     |
|  stage2                               |  3.217M                |  0.101T    |  0.512G        |
|   stage2.reshape                      |   58.68K               |   1.475G   |   2.949M       |
|    stage2.reshape.1                   |    0.96K               |    58.982M |    0           |
|    stage2.reshape.2                   |    57.72K              |    1.416G  |    2.949M      |
|   stage2.residual_group1.blocks       |   1.245M               |   36.699G  |   0.418G       |
...
|    stage2.linear2.weight              |    (120, 120)          |            |                |
|    stage2.linear2.bias                |    (120,)              |            |                |
|   stage2.pa_deform                    |   1.249M               |   50.412G  |   35.684M      |
|    stage2.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage2.pa_deform.bias              |    (120,)              |            |                |
|    stage2.pa_deform.conv_offset       |    1.12M               |    50.412G |    35.684M     |
|   stage2.pa_fuse                      |   0.303M               |   7.432G   |   20.644M      |
|    stage2.pa_fuse.fc11                |    0.13M               |    3.185G  |    8.847M      |
|    stage2.pa_fuse.fc12                |    0.13M               |    3.185G  |    8.847M      |
|    stage2.pa_fuse.fc2                 |    43.32K              |    1.062G  |    2.949M      |
|  stage3                               |  3.217M                |  25.261G   |  0.128G        |
|   stage3.reshape                      |   58.68K               |   0.369G   |   0.737M       |
|    stage3.reshape.1                   |    0.96K               |    14.746M |    0           |
|    stage3.reshape.2                   |    57.72K              |    0.354G  |    0.737M      |
|   stage3.residual_group1.blocks       |   1.245M               |   9.175G   |   0.104G       |
...
|    stage3.linear2.weight              |    (120, 120)          |            |                |
|    stage3.linear2.bias                |    (120,)              |            |                |
|   stage3.pa_deform                    |   1.249M               |   12.603G  |   8.921M       |
|    stage3.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage3.pa_deform.bias              |    (120,)              |            |                |
|    stage3.pa_deform.conv_offset       |    1.12M               |    12.603G |    8.921M      |
|   stage3.pa_fuse                      |   0.303M               |   1.858G   |   5.161M       |
|    stage3.pa_fuse.fc11                |    0.13M               |    0.796G  |    2.212M      |
|    stage3.pa_fuse.fc12                |    0.13M               |    0.796G  |    2.212M      |
|    stage3.pa_fuse.fc2                 |    43.32K              |    0.265G  |    0.737M      |
|  stage4                               |  3.217M                |  6.315G    |  32.016M       |
|   stage4.reshape                      |   58.68K               |   92.16M   |   0.184M       |
|    stage4.reshape.1                   |    0.96K               |    3.686M  |    0           |
|    stage4.reshape.2                   |    57.72K              |    88.474M |    0.184M      |
|   stage4.residual_group1.blocks       |   1.245M               |   2.294G   |   26.1M        |
...
|    stage4.linear2.weight              |    (120, 120)          |            |                |
|    stage4.linear2.bias                |    (120,)              |            |                |
|   stage4.pa_deform                    |   1.249M               |   3.151G   |   2.23M        |
|    stage4.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage4.pa_deform.bias              |    (120,)              |            |                |
|    stage4.pa_deform.conv_offset       |    1.12M               |    3.151G  |    2.23M       |
|   stage4.pa_fuse                      |   0.303M               |   0.464G   |   1.29M        |
|    stage4.pa_fuse.fc11                |    0.13M               |    0.199G  |    0.553M      |
|    stage4.pa_fuse.fc12                |    0.13M               |    0.199G  |    0.553M      |
|    stage4.pa_fuse.fc2                 |    43.32K              |    66.355M |    0.184M      |
|  stage5                               |  3.162M                |  24.916G   |  0.128G        |
|   stage5.reshape                      |   3.78K                |   23.04M   |   0.737M       |
|    stage5.reshape.1                   |    60                  |    0.922M  |    0           |
|    stage5.reshape.2                   |    3.72K               |    22.118M |    0.737M      |
|   stage5.residual_group1.blocks       |   1.245M               |   9.175G   |   0.104G       |
...
|    stage5.linear2.weight              |    (120, 120)          |            |                |
|    stage5.linear2.bias                |    (120,)              |            |                |
|   stage5.pa_deform                    |   1.249M               |   12.603G  |   8.921M       |
|    stage5.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage5.pa_deform.bias              |    (120,)              |            |                |
|    stage5.pa_deform.conv_offset       |    1.12M               |    12.603G |    8.921M      |
|   stage5.pa_fuse                      |   0.303M               |   1.858G   |   5.161M       |
|    stage5.pa_fuse.fc11                |    0.13M               |    0.796G  |    2.212M      |
|    stage5.pa_fuse.fc12                |    0.13M               |    0.796G  |    2.212M      |
|    stage5.pa_fuse.fc2                 |    43.32K              |    0.265G  |    0.737M      |
|  stage6                               |  3.162M                |  99.662G   |  0.512G        |
|   stage6.reshape                      |   3.78K                |   92.16M   |   2.949M       |
|    stage6.reshape.1                   |    60                  |    3.686M  |    0           |
|    stage6.reshape.2                   |    3.72K               |    88.474M |    2.949M      |
|   stage6.residual_group1.blocks       |   1.245M               |   36.699G  |   0.418G       |
...
|    stage6.linear2.weight              |    (120, 120)          |            |                |
|    stage6.linear2.bias                |    (120,)              |            |                |
|   stage6.pa_deform                    |   1.249M               |   50.412G  |   35.684M      |
|    stage6.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage6.pa_deform.bias              |    (120,)              |            |                |
|    stage6.pa_deform.conv_offset       |    1.12M               |    50.412G |    35.684M     |
|   stage6.pa_fuse                      |   0.303M               |   7.432G   |   20.644M      |
|    stage6.pa_fuse.fc11                |    0.13M               |    3.185G  |    8.847M      |
|    stage6.pa_fuse.fc12                |    0.13M               |    3.185G  |    8.847M      |
|    stage6.pa_fuse.fc2                 |    43.32K              |    1.062G  |    2.949M      |
|  stage7                               |  3.162M                |  0.399T    |  2.049G        |
|   stage7.reshape                      |   3.78K                |   0.369G   |   11.796M      |
|    stage7.reshape.1                   |    60                  |    14.746M |    0           |
|    stage7.reshape.2                   |    3.72K               |    0.354G  |    11.796M     |
|   stage7.residual_group1.blocks       |   1.245M               |   0.147T   |   1.67G        |
...
|    stage7.linear2.weight              |    (120, 120)          |            |                |
|    stage7.linear2.bias                |    (120,)              |            |                |
|   stage7.pa_deform                    |   1.249M               |   0.202T   |   0.143G       |
|    stage7.pa_deform.weight            |    (120, 120, 3, 3)    |            |                |
|    stage7.pa_deform.bias              |    (120,)              |            |                |
|    stage7.pa_deform.conv_offset       |    1.12M               |    0.202T  |    0.143G      |
|   stage7.pa_fuse                      |   0.303M               |   29.727G  |   82.575M      |
|    stage7.pa_fuse.fc11                |    0.13M               |    12.74G  |    35.389M     |
|    stage7.pa_fuse.fc12                |    0.13M               |    12.74G  |    35.389M     |
|    stage7.pa_fuse.fc2                 |    43.32K              |    4.247G  |    11.796M     |
