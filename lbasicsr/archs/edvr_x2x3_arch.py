...
class EDVR_x2(EDVR):
    def __init__(self,
                 ...
                 with_tsa=True,
                 scale=2):
        super(EDVR_x2, self).__init__(num_in_ch=num_in_ch,
...
if __name__ == '__main__':
    ...
    # net = EDVR().to(device)
    # EDVR-L -----------------
    model = EDVR_x2(num_feat=128, num_reconstruct_block=40, scale=2).to(device)
    model.eval()
...
EDVR_x2 have 20.043M parameters in total
| module                               | #parameters or shape   | #flops     | #activations   |
|:-------------------------------------|:-----------------------|:-----------|:---------------|
| model                                | 20.043M                | 1.906T     | 1.544G         |
...
|  upsample.0                          |  0.295M                |  16.987G   |  14.746M       |
|   upsample.0.weight                  |   (256, 128, 3, 3)     |            |                |
|   upsample.0.bias                    |   (256,)               |            |                |
|  conv_hr                             |  36.928K               |  8.493G    |  14.746M       |
|   conv_hr.weight                     |   (64, 64, 3, 3)       |            |                |
|   conv_hr.bias                       |   (64,)                |            |                |
|  conv_last                           |  1.731K                |  0.398G    |  0.691M        |
|   conv_last.weight                   |   (3, 64, 3, 3)        |            |                |
|   conv_last.bias                     |   (3,)                 |            |                |
torch.Size([1, 3, 360, 640])


EDVR_x3 have 20.412M parameters in total
| module                               | #parameters or shape   | #flops     | #activations   |
|:-------------------------------------|:-----------------------|:-----------|:---------------|
| model                                | 20.412M                | 1.938T     | 1.582G         |
|  conv_first                          |  3.584K                |  0.995G    |  36.864M       |
|   conv_first.weight                  |   (128, 3, 3, 3)       |            |                |
|   conv_first.bias                    |   (128,)               |            |                |
|  feature_extraction                  |  1.476M                |  0.425T    |  0.369G        |
...
|    reconstruction.39.conv1           |    0.148M              |    8.493G  |    7.373M      |
|    reconstruction.39.conv2           |    0.148M              |    8.493G  |    7.373M      |
|  upsample.0                          |  0.664M                |  38.221G   |  33.178M       |
|   upsample.0.weight                  |   (576, 128, 3, 3)     |            |                |
|   upsample.0.bias                    |   (576,)               |            |                |
|  conv_hr                             |  36.928K               |  19.11G    |  33.178M       |
|   conv_hr.weight                     |   (64, 64, 3, 3)       |            |                |
|   conv_hr.bias                       |   (64,)                |            |                |
|  conv_last                           |  1.731K                |  0.896G    |  1.555M        |
|   conv_last.weight                   |   (3, 64, 3, 3)        |            |                |
|   conv_last.bias                     |   (3,)                 |            |                |
