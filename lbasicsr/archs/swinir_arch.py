...
def window_partition(x, window_size):
    ...
    """
    b, h, w, c = x.shape
    # view: -> [B, H方向的num_window, Wh, W方向的num_window, Ww, C]
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, x_size):
        ...
        # partition windows 分区窗口
        # torch.Size([1, 264, 184, 60]) --> torch.Size([759, 8, 8, 60]) --> torch.Size([759, 64, 60])
...
class SwinIR(nn.Module):
    ...
    def __init__(self,
        ...
        self.num_layers = len(depths)       # [6, 6, 6, 6]
        self.embed_dim = embed_dim          # 60
        self.ape = ape                      # False
        self.patch_norm = patch_norm        # True
        self.num_features = embed_dim       # 60
        self.mlp_ratio = mlp_ratio          # 2

        # split image into non-overlapping patches
        self.patch_embed = PatchEmbed(
            img_size=img_size,              # (264, 184)
