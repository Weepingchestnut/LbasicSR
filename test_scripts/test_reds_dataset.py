...
def main(mode='folder'):
    ...
    if mode == 'folder':
        opt['dataroot_gt'] = '/data2/lzk_data/workspace/LbasicSR/datasets/REDS/train_sharp'
        opt['dataroot_lq'] = '/data2/lzk_data/workspace/LbasicSR/datasets/REDS/train_sharp_bicubic'
        opt['dataroot_flow'] = None
        opt['meta_info_file'] = '/data2/lzk_data/workspace/LbasicSR/lbasicsr/data/meta_info/meta_info_REDS_GT.txt'
        opt['io_backend'] = dict(type='disk')
    elif mode == 'lmdb':
        opt['dataroot_gt'] = '/data2/lzk_data/workspace/LbasicSR/datasets/REDS/train_sharp_with_val.lmdb'
        opt['dataroot_lq'] = '/data2/lzk_data/workspace/LbasicSR/datasets/REDS/train_sharp_bicubic_with_val.lmdb'
        opt['dataroot_flow'] = None
        opt['meta_info_file'] = '/data2/lzk_data/workspace/LbasicSR/lbasicsr/data/meta_info/meta_info_REDS_GT.txt'
