...
def main(mode='folder'):
    ...
    if mode == 'folder':
        opt['dataroot_gt'] = '/data2/lzk_data/workspace/LbasicSR/datasets/DIV2K/DIV2K_train_HR_sub'
        opt['dataroot_lq'] = '/data2/lzk_data/workspace/LbasicSR/datasets/DIV2K/DIV2K_train_LR_bicubic/X4_sub'
        opt['filename_tmpl'] = '{}'
